...
def get_server_parameters(arguments=None):
    ...
    parser.add_option("-f", "--fd", type="int", dest="file_descriptor", help="The file descriptor number to listen for connections on (--port and --ip will be ignored if this is set) [default: %default].")
