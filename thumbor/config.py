...
Config.define('IGNORE_SMART_ERRORS', False,
...
Config.define('GIF_ENGINE', 'thumbor.engines.gif',
...
# SIGNER MODULE
Config.define('URL_SIGNER', 'libthumbor.url_signers.base64_hmac_sha1',
