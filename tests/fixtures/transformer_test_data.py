...
class TestData(object):
    ...
    def __str__(self):
        ...
        return (
            "For an image of %dx%d resizing to %sx%s,"
            " %sit should resize to %sx%s"
        ) % (
            self.source_width,
            self.source_height,
            self.target_width,
    ...
    def has_resized_properly(self):
        ...
        if (
            ...
            or (self.target_width == "orig" and self.target_height == "orig")
        ):
            return True
