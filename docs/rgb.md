...
- `rAmount` - The amount of redness in the picture. Can range from -100 to 100
  in percentage.
- `gAmount` - The amount of greenness in the picture. Can range from -100 to 100
  in percentage.
- `bAmount` - The amount of blueness in the picture. Can range from -100 to 100
  in percentage.
