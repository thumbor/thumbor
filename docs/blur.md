...
- `radius` - Radius used in the gaussian function to generate a matrix, maximum
  value is 150. The bigger the radius more blurred will be the image.
- `sigma` - Optional. Defaults to the same value as the radius. Sigma used in
