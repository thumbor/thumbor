...
## Quality index used for generated WebP images. If not set (None), the same
## level
...
## Size of the thread pool used for image transformations. The default value
## is 0
...
## The maximum number of simultaneous HTTP connections the loader can make
## before
## queuing
## Defaults to: 10
#HTTP_LOADER_MAX_CLIENTS = 10

## Indicates whether thumbor should forward the user agent of the requesting
## user
## Defaults to: False
#HTTP_LOADER_FORWARD_USER_AGENT = False
...
## If HTTP_LOADER_CURL_LOW_SPEED_LIMIT and
## HTTP_LOADER_CURL_ASYNC_HTTP_CLIENT are
...
## List of filters that thumbor will allow to be used in generated images. All
## of
