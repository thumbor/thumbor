...
In order to implement your own result storage, you have to implement a few
methods. A reference implementation is available at
`thumbor/result_storages/file_storage.py` in the
